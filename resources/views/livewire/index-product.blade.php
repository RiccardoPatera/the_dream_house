<aside>
    <div class="container-fluid  ">
        <div class="row tw-justify-between ">
            ...
            <div class="col-lg-3 p-3   main-color tw-min-h-screen d-none d-lg-flex flex-col tw-rounded">
            ...
            {{-- Info Ricerca --}}
            <div  class="col-12 col-lg-9 tw-px-5  ">
                <div class="row  justify-content-center  ">
                    ...
                    <div class="col-12 tw-flex tw-justify-between main-color tw-rounded tw-flex-col tw-p-2 tw-mt-2 lg:tw-mt-0 ">
                        <div class="row tw-p-2 tw-justify-center">
                            ...
                            <p class="text-center  lg:tw-rounded  tw-bg-white tw-p-1 m-1 col-4  ">Range: {{ $range_min_searched}} - {{$range_max_searched}} &euro;</p>
                    ...
                    {{-- OffCanvas Filter --}}
                    <div class="col-12 tw-mt-3 lg:tw-hidden ">
                        ...
                        <div class="col-12 mb-3 main-color rounded mt-2">
                            <div class="row  d-lg-flex tw-h-full p-2  tw-my-2">
                                <div class=" col-6 col-lg-4 tw-text-center tw-flex tw-flex-col  tw-justify-evenly tw-content-center  ">
                                    <h4 class=" tw-text-center  tw-font-bold t  lg:tw-hidden">{{$product->title}}</h4 >
                                ...
                                <div class=" col-0 col-lg-4  tw-flex-col d-none d-lg-flex tw-justify-between md:tw-justify-end tw-items-center tw-mt-7 md:tw-mt-0 ">
                                    <div class="row tw-justify-center tw-text-center">
                                        <h4 class=" tw-text-center  tw-font-bold">{{$product->title}}</h4 >
                                        <p class="col-8  tw-hidden md:tw-flex  tw-text-center">{{$product->description}}</p>
                                        ...
                                        @foreach ( $product->occurences as $occurence )
                                                <p class="rounded acc-bg p-1  tw-text-white col-9  tw-text-center tw-h-fit" >{{$occurence->name}}</p>
                                        @endforeach
                                    </div>
                                </div>
